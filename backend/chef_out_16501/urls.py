"""chef_out_16501 URL Configuration
...
admin.site.site_header = "Chef Out"
admin.site.site_title = "Chef Out Admin Portal"
admin.site.index_title = "Chef Out Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="Chef Out API",
        default_version="v1",
        description="API documentation for Chef Out App",
    ),
    public=True,
